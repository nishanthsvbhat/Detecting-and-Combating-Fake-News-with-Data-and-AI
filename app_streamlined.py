"""
🏆 FAKE NEWS DETECTION SYSTEM - STREAMLINED v3.0
================================================
Simple, Fast, Direct:
✅ 5 ML Models (Ensemble Voting)
✅ Gemini LLM (Auto-configured)
✅ NewsAPI Integration
✅ Direct Text Input (Type & Analyze)
✅ No Complex Options
...
def initialize_gemini():
    ...
    try:
        ...
        st.warning(f"⚠️ Gemini not available: {str(e)}")
        return False
...
def main():
    ...
    st.markdown("**Analyze news with 5 ML models + Gemini AI**")
    st.divider()
    ...
    if st.session_state.analysis_result:
        ...
        tab1, tab2, tab3, tab4 = st.tabs(["🤖 Model Breakdown", "🧠 Gemini Analysis", "🔍 Bias Detection", "📰 Related Articles"])
        ...
        with tab2:
            ...
            with st.spinner('🤖 Gemini is analyzing...'):
                gemini_analysis = analyze_with_gemini(result['text'], prediction)
